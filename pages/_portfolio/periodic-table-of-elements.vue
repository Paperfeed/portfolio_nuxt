<template>
    <div class="container-fluid periodictable">
...
<script>
    ...
    export default {
        ...
        info: {
            order: 80,
            name: 'Periodic Table of Elements',
            description: 'The periodic table of elements loaded in by JSON. HTML generated by javascript (at a time of no reactive frameworks)',
            thumbnail: 'periodictable.png',
        },
        mounted() {
            let blocks = 1,
                htmlString = '',
...
<style scoped lang="scss" src="bootstrap-scss/bootstrap.scss"/>
