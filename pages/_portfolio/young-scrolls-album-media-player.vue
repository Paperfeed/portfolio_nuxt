    ...
    <div>
        ...
        <main ref="main" id='main' :class="playing ? 'playing' : ''">
            <div class='aspectratio'>
                <img ref="overlay" id='overlay' :class="playing ? 'hidden' : ''" src='https://img.youtube.com/vi/RPxvTd_jCPQ/maxresdefault.jpg' alt=""/>
            ...
            <div class='track-info flex' id='listen'>
                <table ref="trackList" id='track-list'>
                    <tbody>
                    <tr><td>1.</td><td>Pretty Boy</td><td>02:23</td></tr>
                    <tr><td>2.</td><td>Drink Water</td><td>02:03</td></tr>
                    <tr><td>3.</td><td>Sauce (feat. Gourmet)</td><td>02:12</td></tr>
                    <tr><td>4.</td><td>Foreign Whips</td><td>02:00</td></tr>
                    <tr><td>5.</td><td>Zoomin (feat. Dervenin)</td><td>02:05</td></tr>
                    <tr><td>6.</td><td>Xedilian</td><td>01:37</td></tr>
                    <tr><td>7.</td><td>Juice (feat. Runs-In-Circles)</td><td>03:20</td></tr>
                    <tr><td>8.</td><td>Cliff Racer (feat. Aldos Othran)</td><td>03:11</td></tr>
                    <tr><td>9.</td><td>Stupid (feat. Sanguine)</td><td>01:52</td></tr>
                    <tr><td>10.</td><td>Sharp Dresser (feat. Syl)</td><td>02:14</td></tr>
                    <tr><td>11.</td><td>Gucci God</td><td>02:09</td></tr>
                    </tbody>
                </table>
                <div class='controls'>
                    ...
                    <div class='flex center'>
                        ...
                        <i @click="playPause" ref="playpause" id='playpauseicon' class="playback" :class="ready && !buffering ? (playing ? 'far fa-pause-circle' : 'far fa-play-circle') : 'fas fa-spinner loading'"></i>
                    ...
                    <div class='seekbar flex center'><span id='seek-current'>{{parseSeekToMinutes(currentSeek)}}</span>
                        <input type="range" min="0" @change="onSliderChange" :max="trackInfo.lengthInSeconds" :value="currentSeek" class="slider" id="seek-slider">
            ...
            <div id='donate' class='flex center'>
                <div><i class="fas fa-coffee"></i><p>Buy the young scrolls a <a href='https://ko-fi.com/youngscrolls' alt='Donate a coffee'>skooma coffee.</a></p></div>
                <div><i class="fas fa-shopping-cart"></i><p>You ain't nothing without some Tamriel swagger. Get yourself <a href='https://society6.com/youngerscrolls' alt='young scrolls merchandise'>some merch!</a></p></div>
                <div><i class="fas fa-compact-disc"></i><p>Stream the latest singles <a href='https://soundcloud.com/youngscrolls/sets/zoom' alt='young scrolls merchandise'>at soundcloud</a> - for free! Khajit ain't got nothin' on that discount.</p></div>
            </div>
        </main>
